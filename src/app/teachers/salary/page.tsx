  ...
  return (
    <div className="min-h-screen bg-transparent">
      <div className="container mx-auto p-4 md:p-8 max-w-6xl">
        ...
        {loading ? (
          ...
          <div className="space-y-8">
            ...
            {/* Final Salary Card */}
            <Card className="bg-gradient-to-r from-violet-50 to-rose-50 border-indigo-200">
              ...
              <CardContent className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div className="flex items-start gap-2">
                    <FiCheckCircle className="h-4 w-4 text-indigo-600 mt-0.5" />
      ...
      <nav className="fixed bottom-0 left-0 right-0 md:hidden bg-white/95 border-t border-indigo-100 shadow-lg flex justify-around py-2 z-50">
        ...
        <Link href="/teachers/salary" className="flex flex-col items-center text-xs text-indigo-700">
