...
export default function DeductionAdjustmentsPage() {
  ...
  const fetchWaiverHistory = async () => {
    try {
      const res = await fetch("/api/admin/deduction-adjustments/history?limit=50");
      if (res.ok) {
        const data = await res.json();
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <button
              ...
              disabled={loading}
              className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-xl hover:from-purple-700 hover:to-blue-700 disabled:opacity-50 font-medium transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            >
          ...
          <div className="flex gap-4 mb-8">
            <button
              ...
              className="flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-xl hover:from-blue-600 hover:to-cyan-600 disabled:opacity-50 disabled:cursor-not-allowed font-semibold transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            >
              {loading ? (
            ...
            <button
              ...
              className="flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-red-500 to-pink-500 text-white rounded-xl hover:from-red-600 hover:to-pink-600 disabled:opacity-50 disabled:cursor-not-allowed font-semibold transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            ...
            {previewData.length > 0 && reason.trim() && (
              <button
                ...
                className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-xl hover:from-green-600 hover:to-emerald-600 font-medium transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
          ...
          {showHistory && (
            <div className="bg-gray-50 rounded-xl p-6 border-2 border-gray-200 mt-8">
              ...
              {waiverHistory.length > 0 ? (
                ...
                <div className="text-center py-8">
                  ...
                  <h4 className="text-lg font-bold text-gray-900 mb-2">No Waiver History</h4>
                  <p className="text-gray-600">No deduction waivers have been applied yet.</p>
                </div>
              )}
            </div>
          )}
