            ...
            <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:ml-auto w-full">
              ...
              <div className="bg-gray-50 rounded-2xl p-4 text-center border border-gray-200">
                ...
                <div
                  ...
                  title={currencyFormatter.format(statusAmounts[0].value)}
                >
              ...
              <div className="bg-gray-50 rounded-2xl p-4 text-center border border-gray-200">
                ...
                <div
                  className="text-2xl font-bold text-black truncate"
                  title={currencyFormatter.format(statusAmounts[1].value)}
                >
              ...
              <div className="bg-gray-50 rounded-2xl p-4 text-center border border-gray-200">
                ...
                <div
                  className="text-2xl font-bold text-black truncate"
                  title={currencyFormatter.format(statusAmounts[2].value)}
                >
            ...
            <div className="p-6 sm:p-8 lg:p-10">
              <ResponsiveContainer width="100%" height={250}>
                <PieChart>
                  ...
                  <RechartsTooltip
                    formatter={(value) =>
                      currencyFormatter.format(Number(value as number))
                    }
                  />
                  <Legend />
                </PieChart>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Manage payment approvals and rejections
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <p className="text-lg font-mono text-gray-700 bg-gray-50 p-3 rounded-xl break-all whitespace-pre-wrap">
