      ...
      <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-8">
        ...
        <div className="bg-white rounded-3xl shadow-2xl border border-gray-200 p-6 sm:p-8 lg:p-10">
          <div className="flex flex-col lg:flex-row lg:items-center gap-8 mb-8">
            ...
            {/* Stats */}
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 lg:ml-auto">
              ...
              <div className="bg-gray-50 rounded-2xl p-4 text-center border border-gray-200">
                <div className="flex items-center justify-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-semibold text-gray-600">Deduction</span>
                </div>
                <div className="text-2xl font-bold text-black">{totalDeduction}</div>
              </div>
              <div className="bg-gray-50 rounded-2xl p-4 text-center border border-gray-200">
                <div className="flex items-center justify-center gap-2 mb-2">
                  <FiClock className="h-5 w-5 text-gray-600" />
                  <span className="text-sm font-semibold text-gray-600">Avg Late</span>
                </div>
                <div className="text-2xl font-bold text-black">{avgLateness}m</div>
              </div>
            </div>
          </div>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-3xl shadow-2xl border border-gray-200 p-12 text-center">
            ...
            <h3 className="text-3xl font-bold text-black mb-4">Error Loading Analytics</h3>
              ...
              <div className="bg-white rounded-3xl shadow-2xl border border-gray-200 overflow-hidden">
                <div className="p-6 sm:p-8 lg:p-10 border-b border-gray-200">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h2 className="text-2xl font-bold text-black">Lateness & Deduction Trend</h2>
              ...
              <div className="p-6 sm:p-8 lg:p-10 border-b border-gray-200">
                <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h2 className="text-2xl font-bold text-black">Per Controller</h2>
                      <p className="text-gray-600">Lateness analytics by controller</p>
                    </div>
                  </div>
          ...
          <div className="bg-white rounded-3xl shadow-2xl border border-gray-200 p-12 text-center">
            ...
            <h3 className="text-3xl font-bold text-black mb-4">No Analytics Data</h3>
            <p className="text-gray-600 text-xl">No analytics data available for the selected period.</p>
          </div>
        )}
          ...
          <div className="p-6 sm:p-8 lg:p-10 border-b border-gray-200">
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-black">Daily Lateness Management</h2>
          ...
          <div className="p-6 sm:p-8 lg:p-10">
            ...
            {dailyLoading ? (
              <div className="text-center py-12">
                <div className="animate-spin rounded-full h-16 w-16 border-4 border-gray-200 border-t-black mx-auto mb-6"></div>
                <p className="text-black font-medium text-lg">Loading daily lateness...</p>
                <p className="text-gray-500 text-sm mt-2">Please wait while we fetch the data</p>
              </div>
            ) : dailyError ? (
              <div className="text-center py-12">
                    ...
                    {dailyRecords.length === 0 ? (
                      <tr>
                        <td colSpan={8} className="text-center py-20">
                          ...
                          <h3 className="text-3xl font-bold text-black mb-4">No Records Found</h3>
                          <p className="text-gray-600 text-xl">No lateness records found for the selected date.</p>
                        </td>
                      </tr>
                    ) : (
                ...
                <div className="flex justify-between items-center p-6 border-t border-gray-200">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <button
                      ...
                      disabled={dailyPage >= Math.ceil(dailyTotal / dailyPageSize)}
                      className="p-3 border border-gray-300 rounded-xl bg-white text-gray-600 hover:bg-gray-50 disabled:opacity-50 transition-all hover:scale-105"
                    >
                      <FiChevronRight className="h-6 w-6" />
                    </button>
                    <button
                      onClick={() => exportToCSV(dailyRecords, "lateness_daily_management.csv")}
