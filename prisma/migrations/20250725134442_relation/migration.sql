...
CREATE TABLE `QualityAssessment` (
    ...
    `supervisorFeedback` VARCHAR(191) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `AuditLog` ADD CONSTRAINT `AuditLog_admin_fkey` FOREIGN KEY (`adminId`) REFERENCES `admin`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
