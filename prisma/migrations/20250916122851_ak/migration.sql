...
CREATE TABLE `wpos_wpdatatable_23` (
    ...
    INDEX `wpos_wpdatatable_23_youtubeSubject_fkey`(`youtubeSubject`),
    PRIMARY KEY (`wdt_ID`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `wpos_wpdatatable_29` (
    ...
    INDEX `Payment_studentid_fkey`(`studentid`),
    PRIMARY KEY (`wdt_ID`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `question` (
    ...
    INDEX `question_packageId_fkey`(`packageId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `absencerecord` (
    ...
    `isWaived` BOOLEAN NULL DEFAULT false,
...
CREATE TABLE `finalexamresult` (
    ...
    INDEX `finalExamResult_packageId_fkey`(`packageId`),
    INDEX `finalExamResult_studentId_fkey`(`studentId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `subjectpackage` (
    ...
    INDEX `subjectPackage_packageId_fkey`(`packageId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `tarbiaattendance` (
    ...
    INDEX `tarbiaAttendance_packageId_fkey`(`packageId`),
    INDEX `tarbiaAttendance_studId_fkey`(`studId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
